...
#---
title: "Shrinking in response to heat stress and social status aids survival in anemonefish_code"
...
### Read in datasets ####
# Data: PercentChange_Versteeg_etal_2024
R1R2.bmrs <- read.csv("PercentChange_Versteeg_etal_2024.csv")
...
### Read in datasets ####
# Data: Survival_Versteeg_etal_2024.xlsx
R1R2.complete.g <- read.csv("Survival_Versteeg_etal_2024.csv")
...
### Read in datasets ####
# Excel file: R1andR2Shrinking_Versteeg_etal_2024
binomR1R2.b <- read.csv("R1andR2Shrinking_Versteeg_etal_2024.csv")
...
### Read in datasets ####
# Excel file: ARIMA_Versteeg_etal_2024
R1R2_b <- read_csv("ARIMA_Versteeg_etal_2024.csv")
...
ggplot(data = Forecasting, aes(x = LC_Adj, y = Max_Temp_LC)) +
  ...
  facet_wrap(~ GroupID) +
  ggtitle("Maximum temperature trends across lunar cycles 1-4 for each anemone") +
  theme_minimal()
...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# Result 1: Individual clown anemonefish can shrink ####
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
### Bayesian models of growth patterns- considering initial size and rank of the anemonefish and thermal stress ####
...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# Result 2: Shrinking is a function of size and social rank ####
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ## Result 3a: Shrinking is a response to thermal stress ####
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
### Selecting thermal stress predictors ####
...
### Effects estimates for this model extracted as this is the best model for thermal stress. Decision based on loo_comparison
...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# Result 3b: Shrinking is a response to thermal stress and social rank ####
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

### Combining thermal stress models with social factors in anemonefish ####
...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# Result 4: Shrinking is a response to social conflict ####
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

### Shrinking by the end of a lunar cycle - compared to size ratio at the start ####
### Model 14: Size ratio of rank 2: rank 1 at the start of the lunar cycle:
Model.14. <- brm(
...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# Result 5: Clown anemonefish that shrink more also survive more often ####
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
### Result 5a: Clown anemonefish that shrink more in relation to thermal stress also survive more ####
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
### Result 5b: Clown anemonefish initial size does not significantly influence survival ####
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
### Result 5c: Clown anemonefish rank does not significantly influence survival ####
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
### Result 5d: Clown anemonefish shrinking within a breeding pair aids survival ####
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
### Result 5e: The patterns of shrinking in clown anemonefish affects survival ####
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
### Fig1b: The slope estimates of rank 1 and rank 2 clown anemonefish using each of different types of growth patterns, for all observations, shrinking only, andd growth only.
...
R1 <- subset(consistR1R2, Rank == 1)
### Zoom
x_limits.Fig2R1 <- c(40, 85)  
y_limits.Fig2R1 <- c(-3, 4)  

Fig1c <- ggplot(R1, aes(x = Init_TL, y = Perc_change_TL)) + 
  ...
  coord_cartesian(xlim = x_limits.Fig2R1, ylim = y_limits.Fig2R1)
print(Fig1c)
...
R2 <- subset(consistR1R2, Rank == 2) 
### Zoom
x_limits.Fig2R2 <- c(40, 85)  
y_limits.Fig2R2 <- c(-3, 4)  

Fig1d <- ggplot(R2, aes(x = Init_TL, y = Perc_change_TL)) +
  geom_hline(yintercept = 0, color = "black", linetype = "dashed", linewidth = 1, alpha = 0.3) +
  ...
  coord_cartesian(xlim = x_limits.Fig2R2, ylim = y_limits.Fig2R2)
print(Fig1d)
...
Fig2b <- pd.currentTemp.Plot +
  ...
  labs(
    title = "Current thermal stress exposure parameter estimates and contrasts between ranks",
    x = "Parameter values",
    y = "Rank",
    fill = "Value"
  ) +
...
Fig2c <- pd.currentTempContr.Plot +
  annotate("text", x = -0.4, y = 0.05, label = "Contrast rank 1 - rank 2", color = "black", family = "sans", size = 5) +
  labs(
    title = "Current thermal stress exposure contrast between rank 1 and rank 2",
    x = "Parameter values",
...
Fig2e <- pd.precedingTemp.Plot +
  ...
  labs(
    title = "preceding thermal stress exposure parameter estimates and contrasts between ranks",
    x = "Parameter values",
    y = "Rank",
    fill = "Value"
  ) +
...
Fig2f <- pd.precedingTempContr.Plot +
  annotate("text", x = 0.2, y = 0.05, label = "Contrast rank 1 - rank 2", color = "black", family = "sans", size = 5) +
  labs(
    title = "preceding thermal stress exposure contrast between rank 1 and rank 2",
    x = "Parameter values",
    y = "Posterior distribution",
    fill = "Value"
  ) +
...
## Figure Panel 3: Shrinking likelihood ####
## Fig 3a: The likelihood of shrinking was fitted against size ratios of rank 2 to rank 1 at the start of the lunar month.
...
## Fig 3b: Slope estimates for the shrinking likelihood of rank 1 and rank 2 in response to size ratio.
Fig3b <- binomR1R2.c %>%
group_by(Rank) %>%
...
## Fig 3c: Contrast estimates for the shrinking likelihood of rank 1 and rank 2 in response to size ratio.
Fig3c <- binomR1R2.c %>%
group_by(Rank) %>%
modelr::data_grid(Size_R2R1_Initial_scl = (c(.6, .8, 1)- 0.778)/0.0525 ,
Max_Temp_LC_INIT_scl = 0,
...
R1R2.complete.h$MinOverall_FishID_cat <- cut(R1R2.complete.h$MinOverall_FishID, 
                                             ...
                                             include.lowest = TRUE, 
                                             labels = c("Low thermal stress", "Below Average", "Above Average", "High thermal stress"))
...
### Change names
names(custom_temps) <- c("Low thermal stress", "Below average", "Above average", "High thermal stress")
...
Fig4.a$plot <- Fig4.a$plot + 
  ...
  annotate("text", x = 200, y = 0.8, label = "Low temperatures", color = custom_temps["Low thermal stress"], hjust = 0) +
  ...
  annotate("text", x = 200, y = 0.2, label = "High temperatures", color = custom_temps["High thermal stress"], hjust = 0)  +
...
Fig4 <- (Fig4.a$plot/Fig4.b$plot/Fig4.c$plot)
print(Fig4)